...
#define b_tripE5_Pin GPIO_PIN_5
#define b_tripE5_GPIO_Port GPIOE
#define trip_out_Pin GPIO_PIN_6
#define trip_out_GPIO_Port GPIOE
#define adhe1_Pin GPIO_PIN_0
#define adhe1_GPIO_Port GPIOC
#define adhe2_Pin GPIO_PIN_1
#define adhe2_GPIO_Port GPIOC
#define adhe_e_1_Pin GPIO_PIN_2
#define adhe_e_1_GPIO_Port GPIOC
#define adhe_e_4_Pin GPIO_PIN_3
#define adhe_e_4_GPIO_Port GPIOC
